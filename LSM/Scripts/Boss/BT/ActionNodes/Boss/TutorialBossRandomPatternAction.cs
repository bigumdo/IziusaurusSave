...
[NodeDescription(name: "TutorialBossRandomPatternAction", story: "[Boss] [PatternGroupName]", category: "Action", id: "e814e51be6c3f4d3c7d32532b0a7ea92")]
public partial class TutorialBossRandomPatternAction : Action
{
    [SerializeReference] public BlackboardVariable<Boss> Boss;
    [SerializeReference] public BlackboardVariable<string> PatternGroupName;
    ...
    {
        _pattern = PatternManager.Instance.RandomPattern(PatternGroupName.Value);
